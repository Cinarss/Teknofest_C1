...
import 'package:teknofest_c1/levelLise/level13.dart';
...
Timer ?timer;
class level42 extends StatefulWidget {
  level42({Key? key}) : super(key: key);

  @override
  State<level42> createState() => _level42State();
}
class _level42State extends State<level42> {
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum42.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum42.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum42.liseCevapKontrol("A");
                                benimSorum42.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum42.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum42.liseCevapKontrol("B");
                               benimSorum42.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum42.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum42.liseCevapKontrol("C");
                               benimSorum42.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum42.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum42.liseCevapKontrol("D");
                                benimSorum42.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      liseCounter = 100;
        ...
        puanGuncelle();
        // veriKaydet();
        Color liseSeviye13Color = Color(0XFFF90000);
                    Navigator.push(
              context,
    ...
    Center(
            ...
            shape:  MaterialStateProperty.all<RoundedRectangleBorder>(
                  ...
                  label: Text("13.Seviye",style: TextStyle(
                    fontSize: 20,
                    color: Colors.white
                  ),),
