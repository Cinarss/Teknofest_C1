...
import 'package:teknofest_c1/levelLise/level10.dart';
...
import 'package:teknofest_c1/levelLise/level6.dart';
import 'package:teknofest_c1/levelLise/level7.dart';
import 'package:teknofest_c1/levelLise/level8.dart';
import 'package:teknofest_c1/levelLise/level9.dart';
...
Timer ?timer;
class level39 extends StatefulWidget {
  level39({Key? key}) : super(key: key);

  @override
  State<level39> createState() => _level39State();

  
}
class _level39State extends State<level39> {
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum39.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum39.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              ...
                              setState(() {
                                ...
                                benimSorum39.cevapKontrol("A");
                                benimSorum39.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum39.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum39.cevapKontrol("B");
                               benimSorum39.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum39.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum39.cevapKontrol("C");
                               benimSorum39.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum39.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum39.cevapKontrol("D");
                                benimSorum39.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      liseCounter = 100;
        ...
        puanGuncelle();
        // veriKaydet();
        Color liseSeviye10Color = Color(0XFF01080D);
                    Navigator.push(
              context,
    ...
    Center(
            ...
            shape:  MaterialStateProperty.all<RoundedRectangleBorder>(
                  ...
                  label: Text("10.Seviye",style: TextStyle(
                    fontSize: 20,
                    color: Colors.white
                  ),),
