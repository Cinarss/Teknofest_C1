...
Timer ?timer;
class level35 extends StatefulWidget {
  level35({Key? key}) : super(key: key);

  @override
  State<level35> createState() => _level35State();

  
}
class _level35State extends State<level35> {
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum35.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum35.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              ...
                              setState(() {
                                ...
                                benimSorum35.cevapKontrol("A");
                                benimSorum35.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum35.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum35.cevapKontrol("B");
                               benimSorum35.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum35.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum35.cevapKontrol("C");
                               benimSorum35.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum35.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum35.cevapKontrol("D");
                                benimSorum35.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
...
class _sonrakiSeviyeState extends State<sonrakiSeviye> {
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      timer?.cancel();
      liseCounter = 100;
        liseDisable5Rozet = 1.0;
        bilgiGetir();
        puanGuncelle();
        // veriKaydet();
        Color liseSeviye6Color = Color(0XFF1DFFA0);
                    Navigator.push(
              context,
