...
Timer ?timer;
class level36 extends StatefulWidget {
  level36({Key? key}) : super(key: key);

  @override
  State<level36> createState() => _level36State();

  
}
class _level36State extends State<level36> {
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum36.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum36.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              ...
                              setState(() {
                                ...
                                benimSorum36.cevapKontrol("A");
                                benimSorum36.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum36.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum36.cevapKontrol("B");
                               benimSorum36.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum36.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum36.cevapKontrol("C");
                               benimSorum36.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum36.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum36.cevapKontrol("D");
                                benimSorum36.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 1300){
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      liseCounter = 100;
        ...
        puanGuncelle();
        // veriKaydet();
        Color liseSeviye7Color = Color(0XFF1DFFA0);
                    Navigator.push(
              context,
    ...
    Center(
            ...
            shape:  MaterialStateProperty.all<RoundedRectangleBorder>(
                  ...
                  label: Text("7.Seviye",style: TextStyle(
                    fontSize: 20,
                    color: Colors.white
                  ),),
