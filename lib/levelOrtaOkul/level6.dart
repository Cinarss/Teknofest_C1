            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum21.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum21.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum21.ortaOkulCevapKontrol("A");
                                benimSorum21.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum21.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum21.ortaOkulCevapKontrol("B");
                               benimSorum21.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum21.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum21.ortaOkulCevapKontrol("C");
                               benimSorum21.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum21.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum21.ortaOkulCevapKontrol("D");
                                benimSorum21.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
