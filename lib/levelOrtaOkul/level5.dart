...
import 'package:teknofest_c1/levelOrtaOkul/level3.dart';
import 'package:teknofest_c1/levelOrtaOkul/level4.dart';
import 'package:teknofest_c1/levelOrtaOkul/level5.dart';
import 'package:teknofest_c1/levelOrtaOkul/level6.dart';
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum20.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum20.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              ...
                              setState(() {
                                ...
                                benimSorum20.cevapKontrol("A");
                                benimSorum20.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum20.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum20.cevapKontrol("B");
                               benimSorum20.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum20.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum20.cevapKontrol("C");
                               benimSorum20.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum20.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum20.cevapKontrol("D");
                                benimSorum20.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
...
class _sonrakiSeviyeState extends State<sonrakiSeviye> {
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      timer?.cancel();
      ortaOkulCounter = 80;
        ortaokulDisable5Rozet = 1.0;
        bilgiGetir();
        puanGuncelle();
        // veriKaydet();
        ortaOkulSeviye6Color = Color(0XFF0384FB);
                    Navigator.push(
              context,
    ...
    Center(
            ...
            shape:  MaterialStateProperty.all<RoundedRectangleBorder>(
                  ...
                  label: Text("6.Seviye",style: TextStyle(
                    fontSize: 20,
                    color: Colors.white
                  ),),
