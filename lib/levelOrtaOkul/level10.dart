...
class level25 extends StatefulWidget {
  level25({Key? key}) : super(key: key);

  @override
  State<level25> createState() => _level25State();
}
class _level25State extends State<level25> {
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum25.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum25.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum25.ortaOkulCevapKontrol("A");
                                benimSorum25.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum25.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum25.ortaOkulCevapKontrol("B");
                               benimSorum25.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum25.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum25.ortaOkulCevapKontrol("C");
                               benimSorum25.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum25.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum25.ortaOkulCevapKontrol("D");
                                benimSorum25.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 900){
...
class _sonrakiSeviyeState extends State<sonrakiSeviye> {
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 1300){
      ...
      timer?.cancel();
      ortaOkulCounter = 80;
        ortaokulDisable10Rozet = 1.0;
        bilgiGetir();
        puanGuncelle();
        // veriKaydet();
        ortaOkulSeviye11Color = Color(0XFF1DFFA0);
                    Navigator.push(
              context,
