...
import 'package:teknofest_c1/level%C4%B0lkOkul/level12.dart';
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum11.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum11.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum11.cevapKontrol("A");
                                benimSorum11.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum11.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum11.cevapKontrol("B");
                               benimSorum11.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 650){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum11.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum11.cevapKontrol("C");
                               benimSorum11.sonrakiSoru();
                               sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 650){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum11.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum11.cevapKontrol("D");
                                benimSorum11.sonrakiSoru();
                                sorusayisi++;
                              });
                              if(sorusayisi >8&& puan >= 650){
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 80){
      ...
      counter = 60;
        ...
        puanGuncelle();
        // veriKaydet();
        Color seviye12Color = Color(0XFFF90000);
                    Navigator.push(
              context,
