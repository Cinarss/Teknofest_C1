...
import 'package:teknofest_c1/level%C4%B0lkOkul/level6.dart';
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.start,
                ...
                */
                ...
                Expanded(flex: 3,
                  child: Center(child: Text(benimSorum5.soruMetni(),style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum5.aSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum5.cevapKontrol("A");
                                benimSorum5.sonrakiSoru();
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum5.bSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum5.cevapKontrol("B");
                               benimSorum5.sonrakiSoru();
                               sorusayisi++;
                              });
                               if(sorusayisi >8&& puan >= 650){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton(style: ButtonStyle(
                            ...
                            child: Text(benimSorum5.cSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum5.cevapKontrol("C");
                               benimSorum5.sonrakiSoru();
                               sorusayisi++;
                              });
                               if(sorusayisi >8&& puan >= 650){
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ElevatedButton( style: ButtonStyle(
                            ...
                            child: Text(benimSorum5.dSikkiYaz(),style: TextStyle(
                              color: Colors.black,
                              fontSize: 23
                            ),),
                            onPressed: (){
                              setState(() {
                                benimSorum5.cevapKontrol("D");
                                benimSorum5.sonrakiSoru();
                                sorusayisi++;
                              });
  ...
  Widget build(BuildContext context) {
    ...
    if(puan >= 80){
      ...
      _onPressed =  (){
        ...
        Color seviye6Color = Color(0XFF1DFFA0);
